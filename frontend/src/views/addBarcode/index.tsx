    ...
    <ScreenLayout image="leafBackground.png">
      <div className="relative flex flex-col justify-center items-center h-screen select-none gap-12">
        ...
        <span className="text-4xl text-center w-[600px]">
          Envianos a este whatsapp una foto del envase con la etiqueta y el
          código de barras VISIBLE
        </span>
        <div className="w-full z-10 flex justify-center">
          <QRCodeComponent value={QrCodeUrl} />
        </div>
        <img src="/images/WhatsappLogo.png" alt="" className="w-20 h-auto" />
        <span className="text-6xl font-bold text-center">+52 999 888 7777</span>
